    ...
    resources: {
        en: {
            translations: {
                ...
                descriptionP3: "As Covid-19 has quarantined many women in a violent household, I aimed to draw a platform where they could securely look for help.",
                bmp: "More projects",
                close: "Close",
                ...
                descriptionV1: "In a confusing time, I seecked for guidelines in how to become a developer. With OpenTechschool Berlin, I have found a community of mentors and newbies, a platform for learning, sharing, guiding and caring. When the opportunity to become a coordinator, has been offered, I got really excited and felt that it was a chance not only to share knowledge but as well to practice vulnerability: from technical to human spectrum: how to talk about code? How to ask the right question to understand someone's issue? How to manage many people wanting to interact at once?",
                ...
                titleV3: "Activism ",
                descriptionV3: "Who doesn't say a word, agree! Being part of a bigger picture implies being active. As a cyclist or pedestrian myself, I believe that cars are, most of the time, extremely useless and inconvenient in cities. This why I participate in Critical Mass and Purple Ride events. To show that what has been granted for so long is not anymore!",
                descriptionC: "Don't be shy, get in touch! I am happy to hear from you for any feedback or questions you may have. ",
        ...
        fr: {
            translations: {
                ...
                descriptionP1: "Le soutien aux communautés locales m'a poussé à devenir développeur. J'ai donc réalisé le site web de ce poumon vert entouré de béton.",
                titleP2: "React.js - Vimetro portfolio",
