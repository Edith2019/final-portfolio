            ...
            <React.Fragment >
                <Container fluid className="mt-5 pt-5" id="Home" >
                    ...
                    <Row className=" mx-5 bg-warning text-center">
                        <Col className=" my-auto" >
                            <h1 id="animate" className="fadeInAbout  mt-5 display-1 text-white" >
                                {t("Welcome")}
                            </h1>
                        </Col>
                    </Row>
                    <Row className="mx-5 pt-2 pb-5 bg-warning text-center">
                        <Col>
                            <svg id="further" width="6em" height="6em" viewBox="0 0 16 16" className=" fadeInAbout  bi bi-chevron-compact-down" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
