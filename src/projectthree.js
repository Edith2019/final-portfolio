            ...
            <React.Fragment>
                <div className="projectthree-container">
                    ...
                    <div className="projectthree-text">
                        ...
                        <p>creation of a social-network for users to come together around a
                            common interest while interacting in private or general chat and personalizing their profiles.</p>
                        <h3>features: </h3>
                        ...
                        <h3>highlights</h3>
                        <p> my favorit and moste complete project so far. it was a thrill to explore
                            the infinite possibilities of redux.</p>
                        <a className="projectthree-text-a" href="https://swork-berlin.herokuapp.com/welcome#/"
                            rel="noopener noreferrer" target="_blank">heroku</a>
                        <a className="projectthree-text-a" href="https://github.com/Edith2019/social-network"
