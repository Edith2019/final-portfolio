                                        ...
                                        <Accordion>
                                            <Accordion.Toggle as={Button} variant="link" eventKey="0" className="p-0" id="featureP">
                                                <Card.Title className="text-warning" >
                                                    Features <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-chevron-double-down" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <Accordion>
                                            <Card.Text>
                                                <Accordion.Toggle as={Button} variant="link" eventKey="0" className="p-0" id="technologiesP">
                                                    <Card.Title className="text-warning">Technologies <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-chevron-double-down" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                        <path fill-rule="evenodd" d="M1.646 6.646a.5.5 0 0 1 .708 0L8 12.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z" />
                                                        <path fill-rule="evenodd" d="M1.646 2.646a.5.5 0 0 1 .708 0L8 8.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z" />
                                                    </svg></Card.Title>
                                                ...
                                                <Accordion.Collapse eventKey="0">
                                                    <Row className="mb-3">
                                                        <Col>
                                                            ...
                                                            {moreProject.technologiesFEMP.map(element => (
                                                                <li>{element}</li>
                                                            ))}
                                                        </Col>
                                                        <Col>
                                                            <p className="font-weight-bold">Back-End</p>
                                                            {moreProject.technologiesBEMP.map(element => (
                                                                <li>{element}</li>
                                                            ))}
                                                        </Col>
                                                    </Row>
