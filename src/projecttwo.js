            ...
            <React.Fragment>
                <div className="projecttwo-container">
                    <div className="projecttwo-text">
                        ...
                        <h3>project&apos;s descriptin:</h3>
                        <p>this work consists of a single page application where anybody can go and post an
                        image with title and description. other features like comments and navigation give users
                        a way to interact with each other and get a community feeling. </p>
                        <h3>features:</h3>
                        ...
                        <a className="projecttwo-text-a" href="https://img-board.herokuapp.com/"
                            rel="noopener noreferrer" target="_blank">heroku</a>
                        <a className="projecttwo-text-a" href="https://github.com/Edith2019/imageboard"
